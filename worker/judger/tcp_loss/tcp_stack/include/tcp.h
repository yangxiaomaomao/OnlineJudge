...
#define less_or_equal_32b(a, b) ((int32_t)((a)-(b)) <= 0)
#define less_than_32b(a, b) ((int32_t)((a)-(b)) < 0)
#define greater_or_equal_32b(a, b) ((int32_t)((a)-(b)) >= 0)
#define greater_than_32b(a, b) ((int32_t)((a)-(b)) > 0)
